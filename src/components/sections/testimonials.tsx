...
export function TestimonialsSection() {
  return (
    <section className="relative pb-16 sm:pb-20 md:pb-24 lg:pb-32 bg-gradient-to-br from-[#FFF5EB] via-[#FFFBF7] to-[#FFF8F0]" style={{ paddingTop: '40px' }}>
      {/* Decorative elements */}
      ...
      <div className="relative w-full max-w-5xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:gap-10 mb-14 sm:mb-16 lg:mb-20">
