      ...
      <div className="relative w-full max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-8 sm:gap-10 md:gap-12">
            ...
            >
              <svg className="w-8 h-8 sm:w-9 sm:h-9 text-[var(--noir-luxe)] group-hover:text-[#E07A5F] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-xs sm:text-sm text-[var(--gris-taupe)] group-hover:text-[#E07A5F] transition-colors">Instagram</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-[var(--gris-taupe)] group-hover:text-[#E07A5F] transition-colors">TikTok</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-[var(--gris-taupe)] group-hover:text-[#E07A5F] transition-colors">YouTube</span>
            </a>
          </div>
        </div>
      </div>
