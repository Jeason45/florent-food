      ...
      <div className="relative max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl px-5 sm:px-8 lg:px-12" style={{ margin: '0 auto' }}>
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-8 sm:gap-10 md:gap-12">
            ...
            >
              <svg className="w-8 h-8 sm:w-9 sm:h-9 text-[var(--noir-luxe)] group-hover:text-[#D4AF37] transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-[var(--gris-taupe)] group-hover:text-[#D4AF37] transition-colors">YouTube</span>
            </a>
          </div>
        </div>
      </div>
