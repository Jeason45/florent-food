...
export default function NewRecipePage() {
  ...
  const handleSubmit = async (status: 'DRAFT' | 'PUBLISHED') => {
    ...
    try {
      ...
      if (data.success) {
        alert(`✅ Recette ${status === 'PUBLISHED' ? 'publiée' : 'sauvegardée en brouillon'} !`);
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)' }}>
            Remplis les champs ci-dessous pour créer une nouvelle recette
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px' }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)', marginTop: '12px' }}>
              💡 Configure d'abord Cloudinary dans ton .env.local
            </p>
          </div>
